...
<div class="col-lg-12 col-md-6 col-sm-12 mb-30 pd-20 bg-white border-radius-4 box-shadow mb-30">
        <h4 class="text-blue">Create new a user</h4>
        <hr>
        @if (count($errors) > 0)
        ...
        {{ csrf_field() }}
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-9">
                    <input name="name" class="form-control" type="text" placeholder="Johnny Brown" value="{{ old('name') }}">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-12 col-md-3 col-form-label">Email</label>
                <div class="col-sm-12 col-md-9">
                    <input class="form-control" name="email" value="{{ old('email') }}" type="email" placeholder="bootstrap@example.com">
                </div>
            </div>
